...
<body>
    <div class="container">
        <h1>Edit Comuna</h1>
        <form method="POST" action="{{ route('comunas.update', ['comuna'=> $comunas->comu_codi]) }}">
            @method('put')
            @cssrf
            <div class="mb-3">
                <label for="codigo" class="form-label">id</label>
                <input type="text" class="form-control" id="id" aria-describedby="codigoHelp" name="id" disabled="disabled" value="{{ $comuna->comune_codi}}">
                <div id="codiHelp" class="form-text">Commune Id.</div>
            </div>
            <div class="mb-3">
